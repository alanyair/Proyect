<?php
  ...
  require_once('conexion.php');
	...
	class Evento extends Conexion{
		...
		public function registroEvento($IdT, $pregunta, $respuesta, $A1, $A2, $A3, $A4){
	    
			parent::conectar();	
			
			#Guardamos los datos en la base de datos;
			parent::query("INSERT INTO quiz (idT, pregunta, respuesta, A1, A2, A3, A4) VALUES ('".$IdT."','".$pregunta."','".$respuesta."','".$A1."','".$A2."','".$A3."','".$A4."')");
